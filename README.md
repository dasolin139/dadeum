...
**▶ 지금 무료로 써보기 (설치·로그인 없이 브라우저에서 바로):**
- 🔎 **AI 티 자가진단** — 내 글에 AI 티가 얼마나 나는지 점수로 확인: https://dasolin139.github.io/dadeum/check/
- 🏠 홈: https://dasolin139.github.io/dadeum/
- ✍️ 블로그(AI 티 잡아내는 법): https://dasolin139.github.io/dadeum/blog/
